...
public class QueenTest {
    ...
    public void testSimpleMove() throws Exception {
        ...
        board.setPiece(new Queen(true, 0, 0), 0, 0);
        Piece piece = board.getPiece(0, 0);
        piece.execMove(board, null, piece, 0, 4);
        assertNotEquals(piece.isValidMove(board, 0, 4), true);
    }

    public void testCapture() throws Exception {
        /* Capture Pawn */
        Board board2 = new Board();
        board2.setPiece(new Queen(true, 0, 0), 0, 0);
    ...
    public void testPieceInWay() throws Exception {
        ...
        board3.setPiece(new Queen(true, 0, 0), 0, 0);
    ...
    public void testIllegalMove() throws Exception {
        ...
        board4.setPiece(new Queen(true, 0,0),0,0);
